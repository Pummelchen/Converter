        ...
        Manual actions by input type:
          ...
          Audio actions:
            ...
            -nfttoshort
              ...
              Output: one ALAC-audio _8K_Short.mp4 capped at 58 seconds plus one ALAC-audio _8K_Short_FullSong.mp4 with the same portrait graphics when input audio is longer than 58 seconds, preserving source audio loudness; uses Vertical_8K.png when present, otherwise uses or creates *_NFT8K.png with black top/bottom padding
            -mp3clean
              Input: one or more .mp3 files in SRC_DIR
