...
final class converterTests: XCTestCase {
    ...
    private static let invalidConfigValues: [InvalidConfigValue] = [
        ...
        // audit #0088: a filter name and the colour tokens are spliced into the ffmpeg filter
        // graph, so a non-empty value must also be a real scaler or a bare ffmpeg token.
        .init("VIDEO_MP4_SCALE_FILTER", "bogus", "VIDEO_MP4_SCALE_FILTER must be one of"),
        .init("VIDEO_MP4_SCALE_FILTER", "lanczos,scale=1:1", "VIDEO_MP4_SCALE_FILTER must be one of"),
        ...
        .init("VIDEO_COLOR_PRIMARIES", "bt709,x=1", "VIDEO_COLOR_PRIMARIES must be an ffmpeg token"),
        .init("VIDEO_COLOR_TRANSFER", "", "VIDEO_COLOR_TRANSFER must not be empty"),
        .init("VIDEO_COLOR_TRANSFER", "bt709:y", "VIDEO_COLOR_TRANSFER must be an ffmpeg token"),
        .init("VIDEO_COLOR_SPACE", "", "VIDEO_COLOR_SPACE must not be empty"),
        .init("VIDEO_COLOR_SPACE", "bt709 z", "VIDEO_COLOR_SPACE must be an ffmpeg token"),
        .init("VIDEO_COLOR_RANGE", "", "VIDEO_COLOR_RANGE must not be empty"),
        .init("VIDEO_COLOR_RANGE", "wide", "VIDEO_COLOR_RANGE must be one of"),
